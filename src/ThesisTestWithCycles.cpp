...
//Add cycle
    ...
    h.graphToGraphviz("ThesisTestWithCycles", goalCompound, startingCompound);
    
    auto dBest = h.yenHyp(goalCompound, startingCompound, 9, true);
    h.printResults(dBest);

    dBest = h.yenHyp(goalCompound, startingCompound, 9, false);
    h.printResults(dBest);
